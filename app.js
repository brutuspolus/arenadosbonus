...
const sponsorCards = [
  ...
  /* ——— CARD 6:  Hugo😄Bets——— */
  {
    ...
    stats: [
      { label: 'Dep. mínimo',    value: '€20' },
      { label: 'Valor do bónus', value: '300% até €1000' },
      { label: 'Rodadas grátis', value: '150 FS' },
      { label: 'Tempo de levant.', value: '0-24h' },
      { label: 'Limite de levant.', value: '€10.000/mês' },
    ...
    backNotes: [
      '🎁 Bónus Boas-Vindas: 300% até 1000€ + 150 Freespins',
      'O bônus de boas-vindas não tem requisitos de aposta',
